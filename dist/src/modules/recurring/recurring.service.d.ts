...
export declare class RecurringService {
    ...
    constructor(recurringRepository: RecurringRepository, paymentMethodsRepository: PaymentMethodsRepository, categoriesService: CategoriesService, transactionsService: TransactionsService, taxCalculatorService: TaxCalculatorService, usersService: UsersService);
