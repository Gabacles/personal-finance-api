...
], CategoriesFilterDto.prototype, "type", void 0);
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List all categories (system + user-defined)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiNoContentResponse)({ description: 'Category deleted successfully.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing or invalid bearer token.' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
