...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create an installment plan (generates N transaction rows)' }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Installment plan created successfully.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing or invalid bearer token.' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_installment_plan_dto_1.CreateInstallmentPlanDto]),
    __metadata("design:returntype", void 0)
], InstallmentsController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'List all installment plans for the authenticated user' }),
    (0, swagger_1.ApiOkResponse)({ description: 'List of installment plans.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing or invalid bearer token.' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Get a single installment plan with its full schedule' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Installment plan with schedule.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing or invalid bearer token.' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Cancel an active installment plan (soft-deletes future installments)' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Installment plan cancelled successfully.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing or invalid bearer token.' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], InstallmentsController.prototype, "cancel", null);
exports.InstallmentsController = InstallmentsController = __decorate([
    (0, swagger_1.ApiTags)('Installment Plans'),
    (0, swagger_1.ApiBearerAuth)('jwt'),
    (0, common_1.Controller)('installment-plans'),
