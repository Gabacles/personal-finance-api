...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'New total monthly budget in BRL cents', example: 600000 }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(1),
    __metadata("design:type", Number)
], UpdateBudgetDto.prototype, "totalBudgetCents", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        type: [create_budget_dto_1.CreateBudgetAllocationDto],
        description: 'Replaces all existing allocations when provided',
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => create_budget_dto_1.CreateBudgetAllocationDto),
